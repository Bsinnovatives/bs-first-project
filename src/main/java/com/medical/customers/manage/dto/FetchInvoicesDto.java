...
public class FetchInvoicesDto {
	...
	private List<FetchItemsDto> fetchItemsDtos;

	public FetchInvoicesDto() {

	}

	public FetchInvoicesDto(UUID invoiceId, String invoiceNo, Date invoiceDate, Double invoiceTotal,
			...
			Double balanceToBePaid, Boolean activeFlag, List<FetchItemsDto> fetchItemsDtos) {
		super();
		...
		this.fetchItemsDtos = fetchItemsDtos;
	}
	...
	public List<FetchItemsDto> getFetchItemsDtos() {
		return fetchItemsDtos;
	}

	public void setFetchItemsDtos(List<FetchItemsDto> fetchItemsDtos) {
		this.fetchItemsDtos = fetchItemsDtos;
	}

	@Override
	public String toString() {
		return "FetchInvoicesDto [invoiceId=" + invoiceId + ", invoiceNo=" + invoiceNo + ", invoiceDate=" + invoiceDate
				...
				+ balanceToBePaid + ", activeFlag=" + activeFlag + ", fetchItemsDtos=" + fetchItemsDtos + "]";
	}
